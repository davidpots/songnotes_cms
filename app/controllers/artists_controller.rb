class ArtistsController < ApplicationController
  ...
  def index
    ...
    # The 'LOWER' text keeps Postgres from being case INsensitive. Via http://stackoverflow.com/questions/2983687/how-to-do-case-insensitive-order-in-rails-with-postgresql
